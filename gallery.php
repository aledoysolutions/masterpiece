      ...
      <div class="container py-lg-5 py-md-3">
        <div class="row cwp23-content">
            <div class="col-lg-6 cwp23-text ">
                <img src="assets/images/pr2.jpeg" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6 cwp23-text ">
              <img src="assets/images/pr6.jpeg" class="img-fluid" alt="">
            </div>
        </div> <br>
        
        <div class="row cwp23-content">
          <div class="col-lg-6 cwp23-text ">
              <img src="assets/images/pr5.jpeg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 cwp23-text ">
              <img src="assets/images/pr8.png" class="img-fluid" alt="">
          </div>
        </div><br>
        
        <div class="row cwp23-content">
          <div class="col-lg-6 cwp23-text ">
            <img src="assets/images/pr4.jpeg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 cwp23-text ">
            <img src="assets/images/pr7.jpeg" class="img-fluid" alt="">
          </div>
        </div>
